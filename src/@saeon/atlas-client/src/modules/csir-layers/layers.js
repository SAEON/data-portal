export default [
  ...
  'https://pta-gis-2-web1.csir.co.za/server2/rest/services/Fire_likelihood_settlements/MapServer',
  ...
  'https://pta-gis-2-web1.csir.co.za/server2/rest/services/coastal_flooding_KZN/MapServer',
  'https://pta-gis-2-web1.csir.co.za/server2/rest/services/coastal_flooding_EC/MapServer',
  'https://pta-gis-2-web1.csir.co.za/server2/rest/services/coastal_flooding_WC/MapServer',
  'https://pta-gis-2-web1.csir.co.za/server2/rest/services/coastal_flooding_NC/MapServer',
  ...
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/SocioEconomic_Vulnerability_Index_2011/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/Economic_Vulnerability_Index_1996/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/Economic_Vulnerability_Index_2011/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/Physical_Vulnerability_Index/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/Environmental_Vulnerability_Index/MapServer',

  // Population growth story map
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/DM_Med_PopEstimates_2030_2050/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/LM_Med_PopEstimates_2030_2050/MapServer',
  // 'https://pta-gis-2-web1.csir.co.za/server2/rest/services/3_PopPressureMatrix_2050M_Filled_Green/MapServer'
]
