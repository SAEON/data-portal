      ...
      <FlatPage>
        <Card className={clsx(classes.card)} variant="outlined">
          ...
          <CardContent>
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              The SAEON Data Portal website located at catalogue.saeon.ac.za is a copyrighted work
              belonging to SAEON Ulwazi Node. Certain features of the Site may be subject to
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              <Link href="https://www.termsofusegenerator.net">Terms Of Use Generator</Link>.
            </Typography>
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              these Terms.  All copyright and other proprietary notices on the Site must be retained
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              third-party websites and services, and/or display advertisements for third-parties. 
              Such Third-Party Links &amp; Ads are not under the control of Company, and Company is
              ...
              risk, and should apply a suitable level of caution and discretion in doing so. When
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              <strong>Cookies and Web Beacons.</strong> Like any other website, SAEON Data Portal
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              company and our suppliers expressly disclaim any and all warranties and conditions of
              ...
              enjoyment, accuracy, or non-infringement.  We and our suppliers make not guarantee
              that the site will meet your requirements, will be available on an uninterrupted,
              timely, secure, or error-free basis, or will be accurate, reliable, free of viruses or
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              such damages.  Access to and use of the site is at your own discretion and risk, and
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              terminated, the following provisions of these Terms will remain in effect: Sections 2
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              for the termination of users of our online Site who are repeated infringers of
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              the e-mail containing such notice will nonetheless constitute effective notice of the
              changes described in the notice.  Any changes to these Terms will be effective upon
              the earliest of thirty (30) calendar days following our dispatch of an e-mail notice
              to you or thirty (30) calendar days following our posting of notice of the changes on
              ...
              of such changes. Dispute Resolution. Please read this Arbitration Agreement carefully.
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              requested relief.  A Notice to the Company should be sent to: Hertzog Blvd, Foreshore,
              Cape Town, 8001. After the Notice is received, you and the Company may attempt to
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              neutral arbitrator.  Any claims or disputes where the total amount of the award sought
              is less than Ten Thousand U.S. Dollars (US $10,000.00) may be resolved through binding
              ...
              arbitration, the Company will pay you the greater of the award or $2,500.00.  Each
              party shall bear its own costs and disbursements arising out of the arbitration and
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              ...
              efficient and less expensive than rules applicable in a court and are subject to very
              limited review by a court.  In the event any litigation should arise between you and
              the Company in any state or federal court in a suit to vacate or enforce an
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              <strong>Copyright/Trademark Information.</strong> Copyright ©. All rights reserved. 
            ...
            <Typography className={clsx(classes.body)} variant="body2">
              Email: {CATALOGUE_LEGAL_CONTACT.replace('@', ' [ at ] ')}
            </Typography>
          </CardContent>
        </Card>
      </FlatPage>
