export default {
  ...
  'sa-district-boundaries-2011-simplified': {
    source: 'github',
    uri:
      'https://github.com/SAEON/catalogue/raw/stable/shapefiles/districts-sa-2011-simplified.zip',
    description: 'Simplified district boundary polygons (2011)'
  },
  'sa-municipality-boundaries-2011-simplified': {
    source: 'github',
    uri:
      'https://github.com/SAEON/catalogue/raw/stable/shapefiles/municipalities-sa-2011-simplified.zip',
